...
- (void)viewDidLoad {
    ...
    [_manager startScanPerpheralTimeout:10];
    _manager.scanPerpheralSuccess = ^(NSArray<CBPeripheral *> *perpherals, BOOL isTimeout){
    ...
    _manager.scanPerpheralFailure = ^(SEScanError error){
